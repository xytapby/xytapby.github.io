...
if ( empty( $current_user ) ) // See http://core.trac.wordpress.org/ticket/14024
	$wp_default_secret_key = 'упішыце сюды ўнікальную фразу';
else
...
function ru_add_spellchecker() {
	return '+Руская=ru,Беларуская=be,Ангельская=en,Датская=da,Іспанская=es,Італьянская=it,Нямецкая=de,Нідэрландская=nl,Польская=pl,Партугальская=pt,Фінская=fi,Французская=fr,Шведская=sv';
}
